...
//  console.log(comment);
//  $.ajax({
//    url: '/resume/e9df4ce4-5f92-46ac-88cc-24f20c7df74e/comment',
//    type: 'POST',
//    data: {"access_token": localStorage.getItem("ResToken"), "comment": comment},
//    //data: comment,
...
var CommentTemplate = require('../templates/resume.ejs');
...
require.register("side-comments/templates/resume.ejs", function(exports, require, module){
